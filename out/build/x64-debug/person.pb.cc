...
const char descriptor_table_protodef_person_2eproto[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
    protodesc_cold) = {
    "\n\014person.proto\022\010tutorial\"2\n\006Person\022\014\n\004na"
...
const ::_pbi::TcParseTable<2, 3, 0, 34, 2> Person::_table_ = {
  {
    0,  // no _has_bits_
    0, // no _extensions_
  ...
  _internal_metadata_.Clear<::google::protobuf::UnknownFieldSet>();
        ...
        ::uint8_t* Person::_InternalSerialize(
          ...
          for (int i = 0, n = this_._internal_emails_size(); i < n; ++i) {
            ...
            ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
                s.data(), static_cast<int>(s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "tutorial.Person.emails");
